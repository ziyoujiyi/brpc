...
#ifndef BRPC_BLOCK_POOL_H
#define BRPC_BLOCK_POOL_H
...
//
// Since IOBuf supports different block size (max: 64KB), the block_pool also
// supports several block sizes: 8KB, 16KB, 32KB and 64KB. The block allocated
